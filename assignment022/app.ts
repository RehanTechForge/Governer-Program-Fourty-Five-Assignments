...
let transportation = ['motorcycle', 'car', 'bicycle', 'boat', 'airplane'];

// Intentionally access an invalid index to produce an index error
const validIndexOrNot = transportation[10] === undefined ? "you must specify a valid index" : transportation[10]
